...
class OrbitControls {
  ...
  // The four arrow keys
  keys: { LEFT: Number, UP: Number, RIGHT: Number, BOTTOM: Number } = { LEFT: 37, UP: 38, RIGHT: 39, BOTTOM: 40 }

  // Mouse buttons
	mouseButtons: { LEFT: THREE.MOUSE, MIDDLE: THREE.MOUSE, RIGHT: THREE.MOUSE } = { LEFT: THREE.MOUSE.LEFT, MIDDLE: THREE.MOUSE.MIDDLE, RIGHT: THREE.MOUSE.RIGHT }
...
const OrbitControls2 = function ( object, domElement ) {
